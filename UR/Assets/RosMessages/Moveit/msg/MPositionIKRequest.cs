...
namespace RosMessageTypes.Moveit
{
    public class MPositionIKRequest : Message
    {
        ...
        public MPositionIKRequest(string group_name, MRobotState robot_state, MConstraints constraints, bool avoid_collisions, string ik_link_name, Geometry.MPoseStamped pose_stamped, string[] ik_link_names, Geometry.MPoseStamped[] pose_stamped_vector, MDuration timeout)
        {
