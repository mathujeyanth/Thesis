...
namespace RosMessageTypes.Moveit
{
    public class MMotionPlanRequest : Message
    {
        ...
        public MGenericTrajectory[] reference_trajectories;
        ...
        public MMotionPlanRequest()
        {
            ...
            this.reference_trajectories = new MGenericTrajectory[0];
            this.planner_id = "";
            this.group_name = "";
        ...
        public MMotionPlanRequest(MWorkspaceParameters workspace_parameters, MRobotState start_state, MConstraints[] goal_constraints, MConstraints path_constraints, MTrajectoryConstraints trajectory_constraints, MGenericTrajectory[] reference_trajectories, string planner_id, string group_name, int num_planning_attempts, double allowed_planning_time, double max_velocity_scaling_factor, double max_acceleration_scaling_factor, string cartesian_speed_end_effector_link, double max_cartesian_speed)
        {
        ...
        public override int Deserialize(byte[] data, int offset)
        {
            ...
            offset += 4;
            this.reference_trajectories= new MGenericTrajectory[reference_trajectoriesArrayLength];
            for(var i = 0; i < reference_trajectoriesArrayLength; i++)
            {
                this.reference_trajectories[i] = new MGenericTrajectory();
