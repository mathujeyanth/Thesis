...
{
    public class MGripperCommandActionResult : ActionResult<MGripperCommandResult>
    {
        public const string RosMessageName = "control_msgs/GripperCommandActionResult";

        public MGripperCommandActionResult() : base()
        {
            this.result = new MGripperCommandResult();
        }

        public MGripperCommandActionResult(MHeader header, MGoalStatus status, MGripperCommandResult result) : base(header, status)
        {
            this.result = result;
        }
