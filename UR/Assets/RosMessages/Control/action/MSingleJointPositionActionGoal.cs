...
{
    public class MSingleJointPositionActionGoal : ActionGoal<MSingleJointPositionGoal>
    {
        public const string RosMessageName = "control_msgs/SingleJointPositionActionGoal";

        public MSingleJointPositionActionGoal() : base()
        {
            this.goal = new MSingleJointPositionGoal();
        }

        public MSingleJointPositionActionGoal(MHeader header, MGoalID goal_id, MSingleJointPositionGoal goal) : base(header, goal_id)
        {
            this.goal = goal;
        }
