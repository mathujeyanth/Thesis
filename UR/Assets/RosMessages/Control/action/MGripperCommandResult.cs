...
{
    public class MGripperCommandResult : Message
    {
        ...
        public MGripperCommandResult(double position, double effort, bool stalled, bool reached_goal)
        {
