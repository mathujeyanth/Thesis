...
{
    public class MGripperCommandActionGoal : ActionGoal<MGripperCommandGoal>
    {
        public const string RosMessageName = "control_msgs/GripperCommandActionGoal";

        public MGripperCommandActionGoal() : base()
        {
            this.goal = new MGripperCommandGoal();
        }

        public MGripperCommandActionGoal(MHeader header, MGoalID goal_id, MGripperCommandGoal goal) : base(header, goal_id)
        {
            this.goal = goal;
        }
