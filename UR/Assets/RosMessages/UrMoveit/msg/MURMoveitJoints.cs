...
{
    public class MURMoveitJoints : Message
    {
        public const string RosMessageName = "ur_moveit/URMoveitJoints";
        ...
        public MURMoveitJoints(double joint_00, double joint_01, double joint_02, double joint_03, double joint_04, double joint_05, Geometry.MPose pick_pose, Geometry.MPose place_pose)
        {
